...
Name: "Airwave." The radio.garden-style interactive globe is now a pinned, durable product decision — it stays through future visual redesigns. Its skin, however, has iterated: after an initial "deep-space cosmic" pass (teal/magenta neon-glass) didn't land, the user asked for a complete visual redesign of everything around the pinned globe. Impeccable rolled a fresh direction: an aizuri-e (Hokusai-style indigo woodblock print) globe — deep Prussian-blue ink-wash oceans, bone/cream linework meridians, a warm vermillion atmospheric halo, gold-leaf-fleck starfield, and station pins as vermillion seal-stamp dots that press down with a one-shot ink-bleed settle when a station starts playing (replacing the earlier continuous neon pulse). Floating chrome (nav pill, player dock, now-playing card, auth form) is opaque cream "paper card" stock with a hairline ink border, not frosted glass. Fraunces (serif, for names/headings) plus Inter (sans, for UI) carry the type. Held at full fidelity, not a placeholder.
